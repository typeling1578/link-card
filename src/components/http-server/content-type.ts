...
export const contentType: { [key: string]: string } = {
    ...
    ".mid": "audio/midi", // or audio/x-midi
    ...
    ".xml": "application/xml", // or text/xml (deprecated), Atom feed is application/atom+xml
    ".xul": "application/vnd.mozilla.xul+xml",
    ".zip": "application/zip", // Windows uploads .zip with MIME type application/x-zip-compressed
